...
var serviceAccount = require("./firebase_auth/tic-app-31369-firebase-adminsdk-ljny5-c92241fe05.json");

admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL: "https://tic-app-31369.firebaseio.com"
});
...
//Delete
//For some reason i get an error if i use DELETE verb instead of PUT
